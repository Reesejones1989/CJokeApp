...
namespace CreateanApp.Controllers
{
    public class JokesController : Controller
    {
        ...
        public JokesController(CreateanAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Joke != null ? 
                          ...
                          Problem("Entity set 'CreateanAppContext.Joke'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CreateanAppContext.Joke'  is null.");
            }
            var joke = await _context.Joke.FindAsync(id);
            if (joke != null)
            {
